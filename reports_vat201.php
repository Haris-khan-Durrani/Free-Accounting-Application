...
<div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8 pb-6 border-b border-slate-200/80 no-print">
    ...
    <div class="flex flex-wrap items-center gap-3 shrink-0">
        ...
        <a href="report_pdf.php?type=vat201&<?=http_build_query($_GET)?>" target="_blank" class="inline-flex items-center px-4 py-2.5 bg-slate-900 hover:bg-slate-800 text-white font-extrabold text-xs rounded-xl shadow-md transition-all space-x-2 border border-slate-800">
