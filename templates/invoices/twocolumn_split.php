                ...
                <tbody>
                    <?php foreach ($items as $it): ?>
                        <tr style="border-bottom: 1px solid #f1f5f9;">
                            <td style="padding: 10px;"><strong><?=e($it['description'])?></strong></td>
                            <td style="padding: 10px; text-align: center; color: #64748b;"><?=e(rtrim(rtrim(number_format((float)$it['qty'], 2), '0'), '.'))?></td>
                            <td style="padding: 10px; text-align: right; color: #64748b;"><?=\Core\Currency::format((float)$it['unit_price'], $currency)?></td>
                            <td style="padding: 10px; text-align: right; font-weight: 700;"><?=\Core\Currency::format((float)$it['amount'], $currency)?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
