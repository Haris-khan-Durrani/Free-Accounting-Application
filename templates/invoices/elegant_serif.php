        ...
        <tbody>
            <?php foreach ($items as $it): ?>
                <tr style="border-bottom: 1px solid #e7e5e4;">
                    ...
                    <td style="padding: 10px; text-align: center;"><?=e(rtrim(rtrim(number_format((float)$it['qty'], 2), '0'), '.'))?></td>
                    <td style="padding: 10px; text-align: right;"><?=\Core\Currency::format((float)$it['unit_price'], $currency)?></td>
                    <td style="padding: 10px; text-align: right; font-weight: bold;"><?=\Core\Currency::format((float)$it['amount'], $currency)?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
