...
// Tax rate management — owner or admin only
if (!has_role(['owner', 'admin'])) {
    flash('error', 'Access denied. Tax rate settings require admin or owner access.');
    redirect('index');
}
...
<!-- Modal: Add Tax Rate -->
<div id="new-tax-modal" class="fixed inset-0 bg-slate-950/60 backdrop-blur-sm flex items-center justify-center z-[100] hidden p-4">
